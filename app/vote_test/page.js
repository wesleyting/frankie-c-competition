...
export default function VotePage() {
  useEffect(() => {
    ...
    script.src = "https://form.jotform.com/jsform/250719140495054";
    script.type = "text/javascript";
    script.async = true;

    const container = document.getElementById("jotform-container");
    if (container) {
      container.innerHTML = ""; // Clear any previous embed
      ...
      <div className="flex flex-col items-center justify-centerz-10">
        <div className="w-full max-w-6xl relative p-4">
          <div className="z-20 relative pb-0">
            <h1 className="mb-6 xl:mb-8 text-center text-3xl font-bold text-white md:text-4xl lg:text-7xl md:leading-[1.2] mt-10">
              Vote for the Best Name!
            </h1>
            <h2 className="text-white text-center text-lg md:text-xl lg:text-2xl">
              Which name fits best? Select your favourite option below.
            </h2>
          </div>

          <div
            id="jotform-container"
            className="z-20 w-full h-full max-w-7xl m-auto"
          />
        </div>
      </div>

      <footer className="bg-black text-white px-12 py-16 pt-10 lg:pt-4">
